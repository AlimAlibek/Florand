...
export default [
    {
        ...
        description: 'Одним из главных преимуществ автомобильной перевозки цветов является ее гибкость. Автомобиль может маневрировать по маршрутам и доставлять цветы непосредственно … // Одним из главных преимуществ автомобильной перевозки цветов является ее гибкость. Автомобиль может маневрировать по маршрутам и доставлять цветы непосредственно'
    },
    {
